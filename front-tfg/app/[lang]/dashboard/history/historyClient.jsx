...
export default function VehicleHistoryClient({ dict }) {
    ...
    // Función de traducción que navega por el JSON
    const t = (path) => {
        ...
        <div className="flex h-screen overflow-hidden bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display">
            ...
            <aside className="hidden lg:flex w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex-col justify-between p-4 shrink-0">
                ...
                <div className="flex flex-col gap-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <button className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-2.5 rounded-lg text-sm flex items-center justify-center gap-2 transition-all">
                        <span className="material-symbols-outlined text-sm">add</span> {t('dashboard.actions.add')}
                    </button>
                </div>
            </aside>
